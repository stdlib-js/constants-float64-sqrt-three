...
```javascript
SQRT3 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-three@v0.0.8-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float64-sqrt-three/actions/workflows/test.yml/badge.svg?branch=v0.0.8
[test-url]: https://github.com/stdlib-js/constants-float64-sqrt-three/actions/workflows/test.yml?query=branch:v0.0.8
